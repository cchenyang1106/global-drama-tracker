...
.section-title { display: block; font-size: 36rpx; font-weight: 800; color: #818cf8; margin-bottom: 24rpx; text-align: center; }
...
.usub { display: block; font-size: 26rpx; color: #64748b; margin-top: 4rpx; }
.info-row { padding: 16rpx 0; border-top: 1rpx solid rgba(255,255,255,0.05); font-size: 28rpx; color: #94a3b8; }
.hobbies { padding: 16rpx 0; border-top: 1rpx solid rgba(255,255,255,0.05); }
.hlabel { font-size: 28rpx; color: #64748b; }
.htags { display: flex; flex-wrap: wrap; gap: 8rpx; margin-top: 8rpx; }
.htag { background: rgba(99,102,241,0.15); color: #818cf8; padding: 6rpx 16rpx; border-radius: 16rpx; font-size: 24rpx; }
...
.save-btn { background: linear-gradient(135deg,#6366f1,#8b5cf6); color: white; border-radius: 12rpx; font-size: 32rpx; font-weight: 700; }
</style>
